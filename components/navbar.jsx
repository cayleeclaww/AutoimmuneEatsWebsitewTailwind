...
{/* second attempt */}
{/* NOTE: make button width smaller/fixed so that dropdown submenu in centered below menu item text */}
...
<div className="group relative ">
    ...
    <ul className="rounded absolute right-0 hidden text-gray-700 pt-1 group-hover:block">
      ...
      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/bydisease/arthritis">arthritis</Link>      </li>
      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
...
{/* bysymptom menu item */}
  <div className="group relative ">
    <button className="text-gray-700 rounded inline-flex items-center group">
      <span className="mr-1 ml-10 uppercase hover:border-b text-l flex"><Link href="/bydisease">by symptom</Link></span>
      <svg
        className="fill-current h-4 w-4 group-hover:rotate-180 transition-transform"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
    ...
    <ul className="rounded absolute right-0 hidden text-gray-700 pt-1 group-hover:block">
      ...
      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/bysymptom/fatigue">fatigue</Link>      </li>
      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
...
{/* nutritionandsupplements menu item */}
  <div className="group relative ">
    <button className="text-gray-700 rounded inline-flex items-center group">
      <span className="mr-1 ml-10 uppercase hover:border-b text-l flex"><Link href="/nutritionandsupplements">nutrition & supplements</Link></span>
      <svg
        className="fill-current h-4 w-4 group-hover:rotate-180 transition-transform"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
    ...
    <ul className="rounded absolute right-0 hidden text-gray-700 pt-1 group-hover:block">
      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/nutritionandsupplements/topsupplements">top supplements</Link>
      </li>
      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/nutritionandsupplements/foodsensitivities">food sensitivities</Link>      </li>
      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/nutritionandsupplements/nutritionrecommendations">nutrition recommendations</Link>
      </li>
    </ul>
  </div>
...
{/* about menu item */}
  <div className="group relative ">
    <button className="text-gray-700 rounded inline-flex items-center group">
      <span className="mr-1 ml-10 uppercase hover:border-b text-l flex"><Link href="/about">about</Link></span>
      {/* <svg
        className="fill-current h-4 w-4 group-hover:rotate-180 transition-transform"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
...
{/* resources menu item */}
  <div className="group relative ">
    <button className="text-gray-700 rounded inline-flex items-center group">
      <span className="mr-1 ml-10 uppercase hover:border-b text-l flex"><Link href="/bydisease">resources</Link></span>
      <svg
        className="fill-current h-4 w-4 group-hover:rotate-180 transition-transform"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
    ...
    <ul className="rounded absolute right-0 hidden text-gray-700 pt-1 group-hover:block">
      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/resources/gaincontroloveryourpsoriasisbook">book</Link>
      </li>
      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/nutritionandsupplements/topsupplements">top supplements</Link>      </li>
      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/resources/hashimotos">hashimoto's</Link>
      </li>

      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/resources/autoimmunenutritionstartersguide">autoimmune nutrition starters' guide</Link>
      </li>

      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/resources/guidedmeditations">guided meditation for eating</Link>
      </li>

      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/resources/candidascreeningform">candida screening form</Link>
      </li>

      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/resources/dinnermealplanner">dinner meal planner</Link>
      </li>

      <li className="bg-gray-200 hover:bg-[#99CED3] py-4 px-4 cursor-pointer">
      <Link href="/resources/trackpsoriasisseverity">track psoriasis severity</Link>
      </li>
