...
const FullscriptSupplement = (props) => {
  ...
  if(settings.return == "product_card") {
    var url = "https://us.fullscript.com/oembed?url=us.fullscript.com/products/" + settings.product_id + "&return=" + settings.return + "&store_slug=" + settings.store_slug;
  } else {
    var url = "https://us.fullscript.com/oembed?url=us.fullscript.com/" + settings.product_ids + "&store_slug=" + settings.store_slug;
  }
  ...
  ajax(url, function(responseText, request) {
    ...
    eventer(messageEvent, function(e) {
      if (e.data.event === "iFrameHeight" && typeof e.data.height === "number") {
