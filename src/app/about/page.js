    ...
    <>
      <div className="w-2/3 mx-auto my-24">
        ...
        <p>
          ...
          physical, mental, emotional, and spiritual issues that are entirely
        ...
        <p>
          <br></br>Both contemporary Western sciences and ancient Indigenous
          sciences are our guiding lights. While natural remedies are the main
          focus, we acknowledge that over-the-counter and prescription
        ...
        <ul>
          ...
          <li>
            ...
            acknowledging that the American food system is broken and, at times,
            poisonous.
          </li>
        </ul>
        <br></br>
        <p>
          Additionally, we recognize that neurodivergent and genderqueer people
