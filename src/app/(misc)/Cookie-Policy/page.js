    ...
    <>
      <div className="w-2/3 mx-auto my-24">
        ...
        <p>
          ...
          https://www.autoimmuneeats.com ("Website"). It explains what these
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">What are cookies?</h2>
        <p>
        ...
        <br></br>{" "}
        <p>
          Cookies set by the website owner (in this case, Eat Your Veggies
          Nutrition PLLC) are called "first-party cookies." Cookies set by
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">Why do we use cookies?</h2>
        <p>
          At this point in time, we do not use cookies. However, we may use
          first- and third-party cookies in the future, for several reasons. In
          the future, some cookies may be required for technical reasons in
          order for our Website to operate, and we will refer to these as
          "essential" or "strictly necessary" cookies. Other cookies will also
          enable us to track and target the interests of our users to enhance
          the experience on our Online Properties. Third parties will serve
          cookies through our Website for advertising, analytics, and other
          purposes. This is described in more detail below. This policy will be
          updated as our use of cookies evolves.
        </p>
        <br></br>
        <h2 className="text-2xl my-4 uppercase">How can I control cookies?</h2>
        <p>
          Once cookies are utilized on this site, you will have the right to
          decide whether to accept or reject cookies. You will be able to
          exercise your cookie rights by setting your preferences in the Cookie
          Consent Manager. The Cookie Consent Manager will allow you to select
        ...
        <br></br>{" "}
        <p>
          Once available, he Cookie Consent Manager will be found in the
          ...
          This policy will be updated once a Cookie Consent Manager is
          available.
        </p>
        <br></br> <p></p>
        <br></br>
        ...
        <p>
          ...
          technologies, please email us at eatyerveg@gmail.com or by post to:
        </p>
        <br></br>{" "}
        <p>
          Eat Your Veggies Nutrition PLLC<br></br> 144 Outlaw Court<br></br>{" "}
          Jefferson, CO 80456<br></br> United States<br></br> Phone: 2017021355
        </p>
        <br></br>
      </div>
    </>
