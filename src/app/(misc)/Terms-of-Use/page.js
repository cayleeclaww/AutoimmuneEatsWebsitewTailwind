  ...
  return (
    <>
      <div className="w-2/3 mx-auto my-24">
        <h1 className="text-3xl my-4">Terms of Use</h1>
        <p>Last updated January 1, 2024</p>
        <h2 className="text-2xl my-4 uppercase">
          AGREEMENT TO OUR LEGAL TERMS
        </h2>
        <p>
          We are Eat Your Veggies Nutrition PLLC, doing business as Autoimmune
          Eats ("Company," "we," "us," "our"), a company registered in Colorado,
          United States at 144 Outlaw Court, Jefferson, CO.
        </p>
        <br></br>
        <p>
          We operate the website https://www.autoimmuneeats.com/ (the "Site"),
        ...
        <br></br>
        <p>
          We provide information on managing autoimmune disease, including
          articles, handouts, resources, recipes, and more.
        </p>
        <br></br>
        <p>
          You can contact us by phone at 2017021355, email at
          eatyerveg@gmail.com, or by mail to 144 Outlaw Court, Jefferson, CO
          80456, United States.
        </p>
        <br></br>
        <p>
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("you"), and Eat
          Your Veggies Nutrition PLLC, concerning your access to and use of the
        ...
        <p>
          1. OUR SERVICES<br></br> 2. INTELLECTUAL PROPERTY RIGHTS <br></br>3.
          USER REPRESENTATIONS<br></br> 4. PRODUCTS<br></br> 5. PURCHASES AND
          PAYMENT<br></br> 6. RETURN/REFUNDS POLICY<br></br> 7. PROHIBITED
          ACTIVITIES<br></br> 8. USER GENERATED CONTRIBUTIONS<br></br> 9.
          CONTRIBUTION LICENSE<br></br> 10. GUIDELINES FOR REVIEWS<br></br> 11.
          THIRD-PARTY WEBSITES AND CONTENT<br></br> 12. ADVERTISERS<br></br> 13.
          SERVICES MANAGEMENT<br></br>14. PRIVACY POLICY<br></br> 15. DIGITAL
          MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY<br></br> 16. TERM
          AND TERMINATION<br></br> 17. MODIFICATIONS AND INTERRUPTIONS<br></br>
          18. GOVERNING LAW<br></br> 19. DISPUTE RESOLUTION<br></br> 20.
          CORRECTIONS<br></br> 21. DISCLAIMER<br></br> 22. LIMITATIONS OF
          LIABILITY<br></br> 23. INDEMNIFICATION<br></br> 24. USER DATA<br></br>
          25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES<br></br>
          26. CALIFORNIA USERS AND RESIDENTS<br></br> 27. MISCELLANEOUS<br></br>
          28. CONTACT US<br></br>
        </p>
        <h2 className="text-2xl my-4 uppercase">1. OUR SERVICES</h2>
        <p>
        ...
        <p>
          ...
          please address your request to: eatyerveg@gmail.com. If we ever grant
        ...
        <p>
          ...
          be treated as a Contribution. You understand that Contributions may be
        ...
        <p>
          ...
          "DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY" section
          below.
        </p>
        <h2 className="text-2xl my-4 uppercase">3. USER REPRESENTATIONS</h2>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">4. PRODUCTS</h2>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">5. PURCHASES AND PAYMENT</h2>
        <p>
          We accept the following forms of payment:<br></br>- Visa<br></br> -
          Mastercard<br></br> - American Express<br></br> - Discover
        </p>
        <br></br>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">6. RETURN/REFUNDS POLICY</h2>
        <p>All sales are final and no refund will be issued.</p>
        <br></br>
        <h2 className="text-2xl my-4 uppercase">7. PROHIBITED ACTIVITIES</h2>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">9. CONTRIBUTION LICENSE</h2>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">10. GUIDELINES FOR REVIEWS</h2>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">14. PRIVACY POLICY</h2>
        <p>
          We care about data privacy and security. Please review our Privacy
          Policy: https://www.autoimmuneeats.com/Privacy-Policy. By using the
        ...
        <br></br>
        <p>
          Designated Copyright Agent<br></br> Caylee Clay <br></br>Attn:
          Copyright Agent <br></br>144 Outlaw Court<br></br>Jefferson, CO 80456
          United States<br></br>eatyerveg@gmail.com
        </p>
        <br></br>
        <h2 className="text-2xl my-4 uppercase">16. TERM AND TERMINATION</h2>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">18. GOVERNING LAW</h2>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">19. DISPUTE RESOLUTION</h2>
        ...
        <p>
          ...
          rules or applicable law, the arbitration will take place in Kings, New
        ...
        <p>
          ...
          and federal courts located in Kings, New York, and the Parties hereby
        ...
        <br></br> <p>Exceptions to Informal Negotiations and Arbitration</p>
        <br></br>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">20. CORRECTIONS</h2>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">21. DISCLAIMER</h2>
        {/* <h2 className="text-2xl my-4 uppercase">21. DISCLAIMER</h2> */}
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">23. INDEMNIFICATION</h2>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">24. USER DATA</h2>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">27. MISCELLANEOUS</h2>
        <p>
        ...
        <br></br>
        <h2 className="text-2xl my-4 uppercase">28. CONTACT US</h2>
        <p>
        ...
        <br></br>
        <p>
          Eat Your Veggies Nutrition PLLC <br></br>144 Outlaw Court<br></br>
          Jefferson, CO 80456<br></br>
          United States<br></br>Phone: 2017021355<br></br>eatyerveg@gmail.com
        </p>
        <br></br>
      </div>
    </>
